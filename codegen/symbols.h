...
typedef struct SymEntry {
    ...
    Type *param_types;
    int param_count;
    int local_num;        /* JVM slot for locals/params; -1 for globals/consts/funcs */
    int scope_depth;      /* 0 = global scope */
    ConstVal cval;        /* set for S_CONST and for S_VAR with initializer */
...
/* Local-slot numbering used by the code generator. Reset on method entry. */
void sym_reset_locals(void);
int  sym_alloc_local(void);
int  sym_current_depth(void);
